...
import com.ecommerce.enums.EnumDescription;

/**
 * The InputUtil class provides utility methods for capturing and validating user input,
 * including generic handling for enums with descriptions.
 */
public class InputUtil {

    /**
     * Prompts the user with a message and retrieves a string input from the console.
    ...
    /**
     * Prompts the user with a message and retrieves an integer input from the console.
     * Validates that the input is a number and falls within the specified range.
     *
     * @param message the message to display to the user
    ...
    /**
     * Prompts the user with a message and retrieves an integer input within a specified range.
    ...
    public static int getIntInputFromUser(String message, int minValue, int maxValue) {
        ...
        try {
            ...
            if (number < minValue || number > maxValue) {
                PrintUtil.printFailMessage("Invalid input. Please enter a number between " + minValue + " and " + maxValue + ".");
    ...
    /**
     * Prompts the user to select an option from an enum type that implements {@link EnumDescription}.
     * The method displays all enum constants with their descriptions and allows the user to select one.
     *
