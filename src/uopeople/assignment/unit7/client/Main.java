...
import uopeople.assignment.unit7.utils.*;
  ...
  * This class handles user input, connection to the chat server, and communication management.
  */
 public class Main {
     ...
     private static void startChat() {
         ...
         System.out.println(
                 "Type '" + ChatCommands.COMMAND_ALL_USERS + "' to get all users connected to the chat server.");
     ...
     public static void log(LogEvent logEvent) {
         switch (logEvent.getTypeLog()) {
             case INFO:
                 PrintUtil.printMessage(logEvent.getFullMessage());
                 break;
             case SUCCESS:
                 PrintUtil.printSuccessMessage(logEvent.getFullMessage());
                 break;
             case WARNING:
                 PrintUtil.printWarningMessage(logEvent.getFullMessage());
                 break;
             case ERROR:
                 PrintUtil.printFailMessage(logEvent.getFullMessage());
                 break;
             default:
     ...
     private static void displayPrivateMessage(String message) {
         ...
         PrintUtil.printWarningMessage("Private message from " + privateMessage.getDisplayName() + ": ",
