 ...
 * console with colored text to enhance user interaction. It uses ANSI escape
 * codes to
...
public class PrintUtil {
    ...
    // ANSI escape code for yellow text color (used for warning or secondary
    // messages)
    public static final String ANSI_YELLOW = "\u001B[33m";
    // ANSI escape code for blue text color (used for additional or informational
    // messages)
    public static final String ANSI_BLUE = "\u001B[34m";

    // ANSI escape code for cyan text color (used for additional or informational
    // messages)
    ...
    public static void printColoredMessage(String greenMessage, String yellowMessage, String blueMessage) {
        String coloredMessage = ANSI_GREEN + greenMessage + " " + ANSI_YELLOW + yellowMessage + " " + ANSI_BLUE
                + blueMessage + ANSI_RESET;
    ...
    public static String getColoredMessage(String greenMessage, String yellowMessage, String blueMessage) {
        return ANSI_GREEN + greenMessage + " " + ANSI_YELLOW + yellowMessage + " " + ANSI_BLUE + blueMessage
                + ANSI_RESET;
    }
    ...
    /**
     * Returns a message formatted in cyan text.
     *
     * @param cyanMessage The message to be formatted in cyan.
     * @return The formatted cyan message as a string.
     */
    public static String getCyanMessage(String cyanMessage) {
        return ANSI_CYAN + cyanMessage + ANSI_RESET;
    }
     ...
     *
     * @param fullMessage The message to be printed.
     */
    public static void printMessage(String fullMessage) {
        System.out.println(fullMessage);
    }

    /**
     * Prints a warning message to the console in yellow text.
     *
     * @param fullMessage The warning message to be printed.
     */
    public static void printWarningMessage(String fullMessage) {
        System.out.println(ANSI_YELLOW + fullMessage + ANSI_RESET);
    }

    /**
     * Prints a combination of a warning message and an additional message.
     *
     * @param warningMessage The warning part of the message.
     * @param message        The additional message.
     */
    public static void printWarningMessage(String warningMessage, String message) {
        PrintUtil.printMessage(PrintUtil.getYellowMessage(warningMessage) + message);
    }
}
